The library is very simple to use, you use it basically the same way you would use Malinskiy's, but there are some things you can do the C# way, like event handling.
